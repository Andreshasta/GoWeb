...
var Invaders = {
 preload: function() {
    ...
    juego.load.image('balas', 'naves/imagenes/bullet.png');
    juego.load.image('ship2', 'naves/imagenes/invader.png');
    juego.load.image('balasEnemiga', 'naves/imagenes/enemy-bullet.png');
    juego.load.image('balasEnemiga2', 'naves/imagenes/enemy-bullet.png');
    juego.load.spritesheet('invader', 'naves/imagenes/invader32x32x4.png', 32, 32);
    juego.load.image('ship', 'naves/imagenes/player.png');
    juego.load.spritesheet('kaboom', 'naves/imagenes/explode.png', 128, 128);
    juego.load.image('starfield', 'naves/imagenes/images.jpg');
...
function enemyHitsPlayer2 (jugador2,bullet) {
      ...
      if (vidas2.countLiving() < 1)
      {
          ...
          stateText.visible = true;
          document.getElementById("VPuntaje").value= score;
